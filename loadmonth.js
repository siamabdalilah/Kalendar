...
function populateEventView(e){
	...
	document.querySelector('#view').querySelector('#date').innerHTML = dat +" " + monthsOfYear[m.month] + ", " + m.year;
	...
	for (const [id, object] of entr){
		...
		cell.innerHTML += "<button name = 'deleteevent' class = 'button' id = 'e" + object.id + "'>Delete</button><br> </div>";
